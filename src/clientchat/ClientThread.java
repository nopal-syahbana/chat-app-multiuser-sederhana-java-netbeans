            ...
            while(!Thread.currentThread().isInterrupted()){
                ...
                switch(CMD){
                    case "CMD_MESSAGE":
                        ...
                        main.appendMessage(msg, frm, Color.GREEN, Color.BLUE);
                        break;
                    ...
                    default: 
                        main.appendMessage("[CMDException]: Pesan Invalid "+ CMD, "CMDException", Color.RED, Color.RED);
                    break;
                }
            }
        } catch(IOException e){
            main.appendMessage(" Koneksi ke Server terputus, silakan coba lagi.!", "KESALAHAN", Color.RED, Color.RED);
        }
    }
}